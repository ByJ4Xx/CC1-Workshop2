...
public class GeneradorListasOrdenadas {
    ...
    public GeneradorListasOrdenadas() {   
    }
    ...
    protected void generarOrdenado(ListaEnlazadaBase<Politico> lista, int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            lista.insertarAlFinal(new Politico(ID_BASE + i, dineroBase, fecha));
